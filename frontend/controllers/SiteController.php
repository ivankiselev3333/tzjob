...
class SiteController extends Controller
{
    ...
    public function actionContact()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            if ($model->sendEmail(Yii::$app->params['adminEmail'])) {
                Yii::$app->session->setFlash(Yii::t('frontend', 'success'),
                    Yii::t('frontend', 'Thank you for contacting us. We will respond to you as soon as possible.'));
            } else {
                Yii::$app->session->setFlash(Yii::t('frontend', 'error'),
    ...
    public function actionResendVerificationEmail()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            ...
            Yii::$app->session->setFlash(Yii::t('frontend', 'error'), Yii::t('frontend',
