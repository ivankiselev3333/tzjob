    ...
    <div class="row">
        <div class="col-lg-5">
            <ul class="tasks">
                ...
                <li class="task">
                    <a href="<?= Url::home('http'); ?>rates/getrates?format=json"> <?= Yii::t('frontend',
                            'json russian utf8'); ?> </a></li>
                <li class="task">
                    <a href="<?= Url::home('http'); ?>rates/getrates?format=jsonp"> <?= Yii::t('frontend',
                            'jsonp russian utf-8'); ?> </a></li>
                <li class="task">
